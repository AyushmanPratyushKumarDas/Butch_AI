  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-gradient-to-br from-[#1a0a1d] via-[#1a1a2e] to-[#2c003e]">
      <div className="w-full max-w-md p-8 bg-black/60 backdrop-blur-md border border-gray-800 rounded-2xl shadow-2xl flex flex-col items-center">
        <h2 className="text-3xl font-extrabold text-center mb-6 bg-gradient-to-r from-indigo-400 via-cyan-400 to-pink-400 bg-clip-text text-transparent drop-shadow-lg">Sign In</h2>
        ...
        <p className="text-center text-gray-400 mt-6 text-sm">
          Don&apos;t have an account? <Link to="/register" className="text-pink-400 hover:underline">Sign up</Link>
        </p>
      </div>
    </div>
  );
